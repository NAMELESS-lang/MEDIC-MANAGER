...
medicamento_funcoes = Blueprint("medicamento_funcoes", __name__) # Digo que este meu script é um blueprint que vai conter as funções(rotas/views) relacionadas aos medicamentos

class Medicamento:
    def __init__(self, id_medicamento,nome_comercial, nome_generico, codigo_identificação
